...
# this allows us to have access/connection
...
def center_window(self, w, h): # pass in the tkinter frame (master) reference and the w and h
    ...
    #calculate xx and y coordinates to pain the app centered on the users screen
...
def onSelect(self,event):
    ...
    with conn:
        ...
        # this returns a tuple and we can slice it into 4 parts using data[] during
        for data in varBody:
